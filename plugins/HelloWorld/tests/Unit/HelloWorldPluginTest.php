...
use Shopologic\Plugins\HelloWorld\HelloWorldPlugin;
use Shopologic\Core\Container\Container;

/**
 * Unit tests for HelloWorldPlugin
 */
class HelloWorldPluginTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->plugin = new HelloWorldPlugin($this->container, '/fake/path');
    }
    
    public function testPluginInstantiation(): void
    {
        $this->assertInstanceOf(HelloWorldPlugin::class, $this->plugin);
    }
