...
namespace Tests\Integration\ab-testing-framework;

use PHPUnit\Framework\TestCase;

/**
 * Integration tests for ab-testing-framework plugin
 */
class ab-testing-frameworkIntegrationTest extends TestCase
{
