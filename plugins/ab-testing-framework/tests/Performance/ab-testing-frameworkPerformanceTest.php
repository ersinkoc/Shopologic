...
namespace Tests\Performance\ab-testing-framework;

use PHPUnit\Framework\TestCase;

/**
 * Performance tests for ab-testing-framework plugin
 */
class ab-testing-frameworkPerformanceTest extends TestCase
{
