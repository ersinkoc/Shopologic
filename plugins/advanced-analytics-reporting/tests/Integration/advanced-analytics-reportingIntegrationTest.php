...
namespace Tests\Integration\advanced-analytics-reporting;

use PHPUnit\Framework\TestCase;

/**
 * Integration tests for advanced-analytics-reporting plugin
 */
class advanced-analytics-reportingIntegrationTest extends TestCase
{
