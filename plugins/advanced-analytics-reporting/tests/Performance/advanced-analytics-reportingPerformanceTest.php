...
namespace Tests\Performance\advanced-analytics-reporting;

use PHPUnit\Framework\TestCase;

/**
 * Performance tests for advanced-analytics-reporting plugin
 */
class advanced-analytics-reportingPerformanceTest extends TestCase
{
