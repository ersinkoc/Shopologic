...
namespace Tests\Security\advanced-analytics-reporting;

use PHPUnit\Framework\TestCase;

/**
 * Security tests for advanced-analytics-reporting plugin
 */
class advanced-analytics-reportingSecurityTest extends TestCase
{
