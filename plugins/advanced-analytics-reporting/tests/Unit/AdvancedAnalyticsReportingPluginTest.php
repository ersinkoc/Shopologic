...
namespace Tests\Unit\advanced-analytics-reporting;

use PHPUnit\Framework\TestCase;
use Shopologic\Plugins\AdvancedAnalyticsReporting\AdvancedAnalyticsReportingPlugin;
use Shopologic\Core\Container\Container;

/**
 * Unit tests for AdvancedAnalyticsReportingPlugin
 */
class AdvancedAnalyticsReportingPluginTest extends TestCase
{
    private AdvancedAnalyticsReportingPlugin $plugin;
    ...
    protected function setUp(): void
    {
        ...
        $this->plugin = new AdvancedAnalyticsReportingPlugin($this->container, '/fake/path');
    }
    
    public function testPluginInstantiation(): void
    {
        $this->assertInstanceOf(AdvancedAnalyticsReportingPlugin::class, $this->plugin);
    }
