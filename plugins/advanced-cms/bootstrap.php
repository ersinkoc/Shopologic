...
/**
 * advanced-cms Plugin Bootstrap
 * 
 * @package Shopologic\Plugins\AdvancedCms
 * @version 1.0.0
 */
...
class AdvancedCmsPlugin extends AbstractPlugin
{
    /**
     * Plugin activation
     */
...
return function(Container $container, string $pluginPath) {
    return new AdvancedCmsPlugin($container, $pluginPath);
};