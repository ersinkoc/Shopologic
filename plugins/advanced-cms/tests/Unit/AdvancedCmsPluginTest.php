...
namespace Tests\Unit\advanced-cms;

use PHPUnit\Framework\TestCase;
use Shopologic\Plugins\AdvancedCms\AdvancedCmsPlugin;
use Shopologic\Core\Container\Container;

/**
 * Unit tests for AdvancedCmsPlugin
 */
class AdvancedCmsPluginTest extends TestCase
{
    private AdvancedCmsPlugin $plugin;
    ...
    protected function setUp(): void
    {
        ...
        $this->plugin = new AdvancedCmsPlugin($this->container, '/fake/path');
    }
    
    public function testPluginInstantiation(): void
    {
        $this->assertInstanceOf(AdvancedCmsPlugin::class, $this->plugin);
    }
