...
namespace Tests\Integration\advanced-email-marketing;

use PHPUnit\Framework\TestCase;

/**
 * Integration tests for advanced-email-marketing plugin
 */
class advanced-email-marketingIntegrationTest extends TestCase
{
