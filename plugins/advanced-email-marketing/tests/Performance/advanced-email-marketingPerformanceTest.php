...
namespace Tests\Performance\advanced-email-marketing;

use PHPUnit\Framework\TestCase;

/**
 * Performance tests for advanced-email-marketing plugin
 */
class advanced-email-marketingPerformanceTest extends TestCase
{
