...
namespace Tests\Security\advanced-email-marketing;

use PHPUnit\Framework\TestCase;

/**
 * Security tests for advanced-email-marketing plugin
 */
class advanced-email-marketingSecurityTest extends TestCase
{
