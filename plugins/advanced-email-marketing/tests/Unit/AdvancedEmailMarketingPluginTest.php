...
namespace Tests\Unit\advanced-email-marketing;

use PHPUnit\Framework\TestCase;
use Shopologic\Plugins\AdvancedEmailMarketing\AdvancedEmailMarketingPlugin;
use Shopologic\Core\Container\Container;

/**
 * Unit tests for AdvancedEmailMarketingPlugin
 */
class AdvancedEmailMarketingPluginTest extends TestCase
{
    private AdvancedEmailMarketingPlugin $plugin;
    ...
    protected function setUp(): void
    {
        ...
        $this->plugin = new AdvancedEmailMarketingPlugin($this->container, '/fake/path');
    }
    
    public function testPluginInstantiation(): void
    {
        $this->assertInstanceOf(AdvancedEmailMarketingPlugin::class, $this->plugin);
    }
