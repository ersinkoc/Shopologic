...
use Shopologic\Plugins\AdvancedEmailMarketing\Services\AutomationEngine;
...
{
    private AutomationEngine $service;
    ...
    protected function setUp(): void
    {
        ...
        $this->service = new AutomationEngine();
    }
    
    public function testServiceInstantiation(): void
    {
        $this->assertInstanceOf(AutomationEngine::class, $this->service);
    }
