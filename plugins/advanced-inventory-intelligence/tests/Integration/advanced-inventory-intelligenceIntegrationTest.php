...
namespace Tests\Integration\advanced-inventory-intelligence;

use PHPUnit\Framework\TestCase;

/**
 * Integration tests for advanced-inventory-intelligence plugin
 */
class advanced-inventory-intelligenceIntegrationTest extends TestCase
{
