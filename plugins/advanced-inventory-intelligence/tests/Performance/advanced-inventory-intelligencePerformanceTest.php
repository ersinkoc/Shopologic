...
namespace Tests\Performance\advanced-inventory-intelligence;

use PHPUnit\Framework\TestCase;

/**
 * Performance tests for advanced-inventory-intelligence plugin
 */
class advanced-inventory-intelligencePerformanceTest extends TestCase
{
