...
namespace Tests\Security\advanced-inventory-intelligence;

use PHPUnit\Framework\TestCase;

/**
 * Security tests for advanced-inventory-intelligence plugin
 */
class advanced-inventory-intelligenceSecurityTest extends TestCase
{
