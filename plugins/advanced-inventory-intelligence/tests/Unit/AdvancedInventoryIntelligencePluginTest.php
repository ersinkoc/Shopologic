...
namespace Tests\Unit\advanced-inventory-intelligence;

use PHPUnit\Framework\TestCase;
use Shopologic\Plugins\AdvancedInventoryIntelligence\AdvancedInventoryIntelligencePlugin;
use Shopologic\Core\Container\Container;

/**
 * Unit tests for AdvancedInventoryIntelligencePlugin
 */
class AdvancedInventoryIntelligencePluginTest extends TestCase
{
    private AdvancedInventoryIntelligencePlugin $plugin;
    ...
    protected function setUp(): void
    {
        ...
        $this->plugin = new AdvancedInventoryIntelligencePlugin($this->container, '/fake/path');
    }
    
    public function testPluginInstantiation(): void
    {
        $this->assertInstanceOf(AdvancedInventoryIntelligencePlugin::class, $this->plugin);
    }
