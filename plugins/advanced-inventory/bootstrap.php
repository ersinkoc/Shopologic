 ...
 * 
 * @package Shopologic\Plugins\AdvancedInventory
 * @version 1.0.0
 */
...
class AdvancedInventoryPlugin extends AbstractPlugin
{
    /**
     * Plugin activation
     */
...
return function(Container $container, string $pluginPath) {
    return new AdvancedInventoryPlugin($container, $pluginPath);
};