...
namespace Tests\Unit\advanced-inventory;

use PHPUnit\Framework\TestCase;
use Shopologic\Plugins\AdvancedInventory\AdvancedInventoryPlugin;
use Shopologic\Core\Container\Container;

/**
 * Unit tests for AdvancedInventoryPlugin
 */
class AdvancedInventoryPluginTest extends TestCase
{
    private AdvancedInventoryPlugin $plugin;
    ...
    protected function setUp(): void
    {
        ...
        $this->plugin = new AdvancedInventoryPlugin($this->container, '/fake/path');
    }
    
    public function testPluginInstantiation(): void
    {
        $this->assertInstanceOf(AdvancedInventoryPlugin::class, $this->plugin);
    }
