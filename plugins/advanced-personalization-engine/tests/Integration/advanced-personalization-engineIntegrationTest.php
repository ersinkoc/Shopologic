...
namespace Tests\Integration\advanced-personalization-engine;

use PHPUnit\Framework\TestCase;

/**
 * Integration tests for advanced-personalization-engine plugin
 */
class advanced-personalization-engineIntegrationTest extends TestCase
{
