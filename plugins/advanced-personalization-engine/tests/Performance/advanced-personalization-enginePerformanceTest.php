...
namespace Tests\Performance\advanced-personalization-engine;

use PHPUnit\Framework\TestCase;

/**
 * Performance tests for advanced-personalization-engine plugin
 */
class advanced-personalization-enginePerformanceTest extends TestCase
{
