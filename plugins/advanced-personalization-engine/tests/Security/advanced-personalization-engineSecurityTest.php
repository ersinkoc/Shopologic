...
namespace Tests\Security\advanced-personalization-engine;

use PHPUnit\Framework\TestCase;

/**
 * Security tests for advanced-personalization-engine plugin
 */
class advanced-personalization-engineSecurityTest extends TestCase
{
