...
namespace Tests\Unit\advanced-personalization-engine;

use PHPUnit\Framework\TestCase;
use Shopologic\Plugins\AdvancedPersonalizationEngine\AdvancedPersonalizationEnginePlugin;
use Shopologic\Core\Container\Container;

/**
 * Unit tests for AdvancedPersonalizationEnginePlugin
 */
class AdvancedPersonalizationEnginePluginTest extends TestCase
{
    private AdvancedPersonalizationEnginePlugin $plugin;
    ...
    protected function setUp(): void
    {
        ...
        $this->plugin = new AdvancedPersonalizationEnginePlugin($this->container, '/fake/path');
    }
    
    public function testPluginInstantiation(): void
    {
        $this->assertInstanceOf(AdvancedPersonalizationEnginePlugin::class, $this->plugin);
    }
