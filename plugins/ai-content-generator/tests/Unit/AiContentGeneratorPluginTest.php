...
namespace Tests\Unit\ai-content-generator;

use PHPUnit\Framework\TestCase;
use Shopologic\Plugins\AiContentGenerator\AiContentGeneratorPlugin;
use Shopologic\Core\Container\Container;

/**
 * Unit tests for AiContentGeneratorPlugin
 */
class AiContentGeneratorPluginTest extends TestCase
{
    private AiContentGeneratorPlugin $plugin;
    ...
    protected function setUp(): void
    {
        ...
        $this->plugin = new AiContentGeneratorPlugin($this->container, '/fake/path');
    }
    
    public function testPluginInstantiation(): void
    {
        $this->assertInstanceOf(AiContentGeneratorPlugin::class, $this->plugin);
    }
