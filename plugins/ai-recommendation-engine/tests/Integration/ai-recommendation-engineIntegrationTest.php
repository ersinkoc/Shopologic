...
namespace Tests\Integration\ai-recommendation-engine;

use PHPUnit\Framework\TestCase;

/**
 * Integration tests for ai-recommendation-engine plugin
 */
class ai-recommendation-engineIntegrationTest extends TestCase
{
