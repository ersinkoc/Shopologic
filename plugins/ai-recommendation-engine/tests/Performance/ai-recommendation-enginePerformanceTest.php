...
namespace Tests\Performance\ai-recommendation-engine;

use PHPUnit\Framework\TestCase;

/**
 * Performance tests for ai-recommendation-engine plugin
 */
class ai-recommendation-enginePerformanceTest extends TestCase
{
