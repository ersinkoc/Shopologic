...
namespace Tests\Unit\ai-recommendation-engine;

use PHPUnit\Framework\TestCase;
use Shopologic\Plugins\AiRecommendationEngine\AiRecommendationEnginePlugin;
use Shopologic\Core\Container\Container;

/**
 * Unit tests for AiRecommendationEnginePlugin
 */
class AiRecommendationEnginePluginTest extends TestCase
{
    private AiRecommendationEnginePlugin $plugin;
    ...
    protected function setUp(): void
    {
        ...
        $this->plugin = new AiRecommendationEnginePlugin($this->container, '/fake/path');
    }
    
    public function testPluginInstantiation(): void
    {
        $this->assertInstanceOf(AiRecommendationEnginePlugin::class, $this->plugin);
    }
