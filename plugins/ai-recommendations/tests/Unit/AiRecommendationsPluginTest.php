...
namespace Tests\Unit\ai-recommendations;

use PHPUnit\Framework\TestCase;
use Shopologic\Plugins\AiRecommendations\AiRecommendationsPlugin;
use Shopologic\Core\Container\Container;

/**
 * Unit tests for AiRecommendationsPlugin
 */
class AiRecommendationsPluginTest extends TestCase
{
    private AiRecommendationsPlugin $plugin;
    ...
    protected function setUp(): void
    {
        ...
        $this->plugin = new AiRecommendationsPlugin($this->container, '/fake/path');
    }
    
    public function testPluginInstantiation(): void
    {
        $this->assertInstanceOf(AiRecommendationsPlugin::class, $this->plugin);
    }
