...
namespace Tests\Unit\analytics-google;

use PHPUnit\Framework\TestCase;
use Shopologic\Plugins\AnalyticsGoogle\AnalyticsGooglePlugin;
use Shopologic\Core\Container\Container;

/**
 * Unit tests for AnalyticsGooglePlugin
 */
class AnalyticsGooglePluginTest extends TestCase
{
    private AnalyticsGooglePlugin $plugin;
    ...
    protected function setUp(): void
    {
        ...
        $this->plugin = new AnalyticsGooglePlugin($this->container, '/fake/path');
    }
    
    public function testPluginInstantiation(): void
    {
        $this->assertInstanceOf(AnalyticsGooglePlugin::class, $this->plugin);
    }
