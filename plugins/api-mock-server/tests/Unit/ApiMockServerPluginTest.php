...
namespace Tests\Unit\api-mock-server;

use PHPUnit\Framework\TestCase;
use Shopologic\Plugins\ApiMockServer\ApiMockServerPlugin;
use Shopologic\Core\Container\Container;

/**
 * Unit tests for ApiMockServerPlugin
 */
class ApiMockServerPluginTest extends TestCase
{
    private ApiMockServerPlugin $plugin;
    ...
    protected function setUp(): void
    {
        ...
        $this->plugin = new ApiMockServerPlugin($this->container, '/fake/path');
    }
    
    public function testPluginInstantiation(): void
    {
        $this->assertInstanceOf(ApiMockServerPlugin::class, $this->plugin);
    }
