...
namespace Tests\Integration\behavioral-psychology-engine;

use PHPUnit\Framework\TestCase;

/**
 * Integration tests for behavioral-psychology-engine plugin
 */
class behavioral-psychology-engineIntegrationTest extends TestCase
{
