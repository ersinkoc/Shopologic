...
namespace Tests\Performance\behavioral-psychology-engine;

use PHPUnit\Framework\TestCase;

/**
 * Performance tests for behavioral-psychology-engine plugin
 */
class behavioral-psychology-enginePerformanceTest extends TestCase
{
