...
namespace Tests\Security\behavioral-psychology-engine;

use PHPUnit\Framework\TestCase;

/**
 * Security tests for behavioral-psychology-engine plugin
 */
class behavioral-psychology-engineSecurityTest extends TestCase
{
