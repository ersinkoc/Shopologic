...
namespace Tests\Unit\behavioral-psychology-engine;

use PHPUnit\Framework\TestCase;
use Shopologic\Plugins\BehavioralPsychologyEngine\BehavioralPsychologyEnginePlugin;
use Shopologic\Core\Container\Container;

/**
 * Unit tests for BehavioralPsychologyEnginePlugin
 */
class BehavioralPsychologyEnginePluginTest extends TestCase
{
    private BehavioralPsychologyEnginePlugin $plugin;
    ...
    protected function setUp(): void
    {
        ...
        $this->plugin = new BehavioralPsychologyEnginePlugin($this->container, '/fake/path');
    }
    
    public function testPluginInstantiation(): void
    {
        $this->assertInstanceOf(BehavioralPsychologyEnginePlugin::class, $this->plugin);
    }
