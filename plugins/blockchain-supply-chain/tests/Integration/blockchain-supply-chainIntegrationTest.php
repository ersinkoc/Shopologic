...
namespace Tests\Integration\blockchain-supply-chain;

use PHPUnit\Framework\TestCase;

/**
 * Integration tests for blockchain-supply-chain plugin
 */
class blockchain-supply-chainIntegrationTest extends TestCase
{
