...
namespace Tests\Security\blockchain-supply-chain;

use PHPUnit\Framework\TestCase;

/**
 * Security tests for blockchain-supply-chain plugin
 */
class blockchain-supply-chainSecurityTest extends TestCase
{
