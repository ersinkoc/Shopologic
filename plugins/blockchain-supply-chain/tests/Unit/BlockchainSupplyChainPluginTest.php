...
namespace Tests\Unit\blockchain-supply-chain;

use PHPUnit\Framework\TestCase;
use Shopologic\Plugins\BlockchainSupplyChain\BlockchainSupplyChainPlugin;
use Shopologic\Core\Container\Container;

/**
 * Unit tests for BlockchainSupplyChainPlugin
 */
class BlockchainSupplyChainPluginTest extends TestCase
{
    private BlockchainSupplyChainPlugin $plugin;
    ...
    protected function setUp(): void
    {
        ...
        $this->plugin = new BlockchainSupplyChainPlugin($this->container, '/fake/path');
    }
    
    public function testPluginInstantiation(): void
    {
        $this->assertInstanceOf(BlockchainSupplyChainPlugin::class, $this->plugin);
    }
