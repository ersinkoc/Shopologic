...
namespace Tests\Integration\blue-green-deployment;

use PHPUnit\Framework\TestCase;

/**
 * Integration tests for blue-green-deployment plugin
 */
class blue-green-deploymentIntegrationTest extends TestCase
{
