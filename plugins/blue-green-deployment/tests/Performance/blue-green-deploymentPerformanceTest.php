...
namespace Tests\Performance\blue-green-deployment;

use PHPUnit\Framework\TestCase;

/**
 * Performance tests for blue-green-deployment plugin
 */
class blue-green-deploymentPerformanceTest extends TestCase
{
