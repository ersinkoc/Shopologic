...
namespace Tests\Unit\blue-green-deployment;

use PHPUnit\Framework\TestCase;
use Shopologic\Plugins\BlueGreenDeployment\BlueGreenDeploymentPlugin;
use Shopologic\Core\Container\Container;

/**
 * Unit tests for BlueGreenDeploymentPlugin
 */
class BlueGreenDeploymentPluginTest extends TestCase
{
    private BlueGreenDeploymentPlugin $plugin;
    ...
    protected function setUp(): void
    {
        ...
        $this->plugin = new BlueGreenDeploymentPlugin($this->container, '/fake/path');
    }
    
    public function testPluginInstantiation(): void
    {
        $this->assertInstanceOf(BlueGreenDeploymentPlugin::class, $this->plugin);
    }
