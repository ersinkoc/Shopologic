...
namespace Tests\Unit\bundle-builder;

use PHPUnit\Framework\TestCase;
use Shopologic\Plugins\BundleBuilder\BundleBuilderPlugin;
use Shopologic\Core\Container\Container;

/**
 * Unit tests for BundleBuilderPlugin
 */
class BundleBuilderPluginTest extends TestCase
{
    private BundleBuilderPlugin $plugin;
    ...
    protected function setUp(): void
    {
        ...
        $this->plugin = new BundleBuilderPlugin($this->container, '/fake/path');
    }
    
    public function testPluginInstantiation(): void
    {
        $this->assertInstanceOf(BundleBuilderPlugin::class, $this->plugin);
    }
