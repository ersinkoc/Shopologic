...
namespace Tests\Integration\code-quality-analyzer;

use PHPUnit\Framework\TestCase;

/**
 * Integration tests for code-quality-analyzer plugin
 */
class code-quality-analyzerIntegrationTest extends TestCase
{
