...
namespace Tests\Performance\code-quality-analyzer;

use PHPUnit\Framework\TestCase;

/**
 * Performance tests for code-quality-analyzer plugin
 */
class code-quality-analyzerPerformanceTest extends TestCase
{
