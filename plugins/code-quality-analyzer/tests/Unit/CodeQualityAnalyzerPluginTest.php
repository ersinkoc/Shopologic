...
namespace Tests\Unit\code-quality-analyzer;

use PHPUnit\Framework\TestCase;
use Shopologic\Plugins\CodeQualityAnalyzer\CodeQualityAnalyzerPlugin;
use Shopologic\Core\Container\Container;

/**
 * Unit tests for CodeQualityAnalyzerPlugin
 */
class CodeQualityAnalyzerPluginTest extends TestCase
{
    private CodeQualityAnalyzerPlugin $plugin;
    ...
    protected function setUp(): void
    {
        ...
        $this->plugin = new CodeQualityAnalyzerPlugin($this->container, '/fake/path');
    }
    
    public function testPluginInstantiation(): void
    {
        $this->assertInstanceOf(CodeQualityAnalyzerPlugin::class, $this->plugin);
    }
