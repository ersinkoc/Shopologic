...
namespace Tests\Integration\container-orchestration;

use PHPUnit\Framework\TestCase;

/**
 * Integration tests for container-orchestration plugin
 */
class container-orchestrationIntegrationTest extends TestCase
{
