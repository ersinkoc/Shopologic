...
namespace Tests\Unit\container-orchestration;

use PHPUnit\Framework\TestCase;
use Shopologic\Plugins\ContainerOrchestration\ContainerOrchestrationPlugin;
use Shopologic\Core\Container\Container;

/**
 * Unit tests for ContainerOrchestrationPlugin
 */
class ContainerOrchestrationPluginTest extends TestCase
{
    private ContainerOrchestrationPlugin $plugin;
    ...
    protected function setUp(): void
    {
        ...
        $this->plugin = new ContainerOrchestrationPlugin($this->container, '/fake/path');
    }
    
    public function testPluginInstantiation(): void
    {
        $this->assertInstanceOf(ContainerOrchestrationPlugin::class, $this->plugin);
    }
