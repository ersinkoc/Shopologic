...
namespace Tests\Unit\core-commerce;

use PHPUnit\Framework\TestCase;
use Shopologic\Plugins\CoreCommerce\CoreCommercePlugin;
use Shopologic\Core\Container\Container;

/**
 * Unit tests for CoreCommercePlugin
 */
class CoreCommercePluginTest extends TestCase
{
    private CoreCommercePlugin $plugin;
    ...
    protected function setUp(): void
    {
        ...
        $this->plugin = new CoreCommercePlugin($this->container, '/fake/path');
    }
    
    public function testPluginInstantiation(): void
    {
        $this->assertInstanceOf(CoreCommercePlugin::class, $this->plugin);
    }
