...
namespace Tests\Performance\customer-lifetime-value-optimizer;

use PHPUnit\Framework\TestCase;

/**
 * Performance tests for customer-lifetime-value-optimizer plugin
 */
class customer-lifetime-value-optimizerPerformanceTest extends TestCase
{
