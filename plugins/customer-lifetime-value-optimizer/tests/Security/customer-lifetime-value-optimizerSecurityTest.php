...
namespace Tests\Security\customer-lifetime-value-optimizer;

use PHPUnit\Framework\TestCase;

/**
 * Security tests for customer-lifetime-value-optimizer plugin
 */
class customer-lifetime-value-optimizerSecurityTest extends TestCase
{
