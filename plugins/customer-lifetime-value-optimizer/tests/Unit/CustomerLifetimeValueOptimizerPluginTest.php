...
namespace Tests\Unit\customer-lifetime-value-optimizer;

use PHPUnit\Framework\TestCase;
use Shopologic\Plugins\CustomerLifetimeValueOptimizer\CustomerLifetimeValueOptimizerPlugin;
use Shopologic\Core\Container\Container;

/**
 * Unit tests for CustomerLifetimeValueOptimizerPlugin
 */
class CustomerLifetimeValueOptimizerPluginTest extends TestCase
{
    private CustomerLifetimeValueOptimizerPlugin $plugin;
    ...
    protected function setUp(): void
    {
        ...
        $this->plugin = new CustomerLifetimeValueOptimizerPlugin($this->container, '/fake/path');
    }
    
    public function testPluginInstantiation(): void
    {
        $this->assertInstanceOf(CustomerLifetimeValueOptimizerPlugin::class, $this->plugin);
    }
