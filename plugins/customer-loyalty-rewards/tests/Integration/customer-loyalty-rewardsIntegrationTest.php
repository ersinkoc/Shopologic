...
namespace Tests\Integration\customer-loyalty-rewards;

use PHPUnit\Framework\TestCase;

/**
 * Integration tests for customer-loyalty-rewards plugin
 */
class customer-loyalty-rewardsIntegrationTest extends TestCase
{
