...
namespace Tests\Performance\customer-loyalty-rewards;

use PHPUnit\Framework\TestCase;

/**
 * Performance tests for customer-loyalty-rewards plugin
 */
class customer-loyalty-rewardsPerformanceTest extends TestCase
{
