...
namespace Tests\Security\customer-loyalty-rewards;

use PHPUnit\Framework\TestCase;

/**
 * Security tests for customer-loyalty-rewards plugin
 */
class customer-loyalty-rewardsSecurityTest extends TestCase
{
