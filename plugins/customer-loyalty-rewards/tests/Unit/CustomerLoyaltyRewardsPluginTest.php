...
namespace Tests\Unit\customer-loyalty-rewards;

use PHPUnit\Framework\TestCase;
use Shopologic\Plugins\CustomerLoyaltyRewards\CustomerLoyaltyRewardsPlugin;
use Shopologic\Core\Container\Container;

/**
 * Unit tests for CustomerLoyaltyRewardsPlugin
 */
class CustomerLoyaltyRewardsPluginTest extends TestCase
{
    private CustomerLoyaltyRewardsPlugin $plugin;
    ...
    protected function setUp(): void
    {
        ...
        $this->plugin = new CustomerLoyaltyRewardsPlugin($this->container, '/fake/path');
    }
    
    public function testPluginInstantiation(): void
    {
        $this->assertInstanceOf(CustomerLoyaltyRewardsPlugin::class, $this->plugin);
    }
