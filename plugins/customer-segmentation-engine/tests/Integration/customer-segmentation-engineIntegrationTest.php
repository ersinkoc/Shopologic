...
namespace Tests\Integration\customer-segmentation-engine;

use PHPUnit\Framework\TestCase;

/**
 * Integration tests for customer-segmentation-engine plugin
 */
class customer-segmentation-engineIntegrationTest extends TestCase
{
