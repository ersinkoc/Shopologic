...
namespace Tests\Performance\customer-segmentation-engine;

use PHPUnit\Framework\TestCase;

/**
 * Performance tests for customer-segmentation-engine plugin
 */
class customer-segmentation-enginePerformanceTest extends TestCase
{
