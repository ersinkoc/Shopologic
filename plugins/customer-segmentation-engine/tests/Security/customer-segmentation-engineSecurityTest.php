...
namespace Tests\Security\customer-segmentation-engine;

use PHPUnit\Framework\TestCase;

/**
 * Security tests for customer-segmentation-engine plugin
 */
class customer-segmentation-engineSecurityTest extends TestCase
{
