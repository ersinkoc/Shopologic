...
namespace Tests\Unit\customer-segmentation-engine;

use PHPUnit\Framework\TestCase;
use Shopologic\Plugins\CustomerSegmentationEngine\CustomerSegmentationEnginePlugin;
use Shopologic\Core\Container\Container;

/**
 * Unit tests for CustomerSegmentationEnginePlugin
 */
class CustomerSegmentationEnginePluginTest extends TestCase
{
    private CustomerSegmentationEnginePlugin $plugin;
    ...
    protected function setUp(): void
    {
        ...
        $this->plugin = new CustomerSegmentationEnginePlugin($this->container, '/fake/path');
    }
    
    public function testPluginInstantiation(): void
    {
        $this->assertInstanceOf(CustomerSegmentationEnginePlugin::class, $this->plugin);
    }
