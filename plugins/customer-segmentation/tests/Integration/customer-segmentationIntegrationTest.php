...
namespace Tests\Integration\customer-segmentation;

use PHPUnit\Framework\TestCase;

/**
 * Integration tests for customer-segmentation plugin
 */
class customer-segmentationIntegrationTest extends TestCase
{
