...
namespace Tests\Performance\customer-segmentation;

use PHPUnit\Framework\TestCase;

/**
 * Performance tests for customer-segmentation plugin
 */
class customer-segmentationPerformanceTest extends TestCase
{
