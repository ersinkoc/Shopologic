...
namespace Tests\Unit\customer-segmentation;

use PHPUnit\Framework\TestCase;
use Shopologic\Plugins\CustomerSegmentation\CustomerSegmentationPlugin;
use Shopologic\Core\Container\Container;

/**
 * Unit tests for CustomerSegmentationPlugin
 */
class CustomerSegmentationPluginTest extends TestCase
{
    private CustomerSegmentationPlugin $plugin;
    ...
    protected function setUp(): void
    {
        ...
        $this->plugin = new CustomerSegmentationPlugin($this->container, '/fake/path');
    }
    
    public function testPluginInstantiation(): void
    {
        $this->assertInstanceOf(CustomerSegmentationPlugin::class, $this->plugin);
    }
