...
/**
 * database-query-optimizer Plugin Bootstrap
 * 
 * @package Shopologic\Plugins\DatabaseQueryOptimizer
 * @version 1.0.0
 */
...
return function(Container $container, string $pluginPath) {
    return new DatabaseQueryOptimizerPlugin($container, $pluginPath);
};