...
namespace Tests\Integration\database-query-optimizer;

use PHPUnit\Framework\TestCase;

/**
 * Integration tests for database-query-optimizer plugin
 */
class database-query-optimizerIntegrationTest extends TestCase
{
