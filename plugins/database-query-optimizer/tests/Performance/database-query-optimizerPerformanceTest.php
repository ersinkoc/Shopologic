...
namespace Tests\Performance\database-query-optimizer;

use PHPUnit\Framework\TestCase;

/**
 * Performance tests for database-query-optimizer plugin
 */
class database-query-optimizerPerformanceTest extends TestCase
{
