...
namespace Tests\Security\database-query-optimizer;

use PHPUnit\Framework\TestCase;

/**
 * Security tests for database-query-optimizer plugin
 */
class database-query-optimizerSecurityTest extends TestCase
{
