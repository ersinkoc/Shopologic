...
namespace Tests\Unit\database-query-optimizer;

use PHPUnit\Framework\TestCase;
use Shopologic\Plugins\DatabaseQueryOptimizer\DatabaseQueryOptimizerPlugin;
use Shopologic\Core\Container\Container;

/**
 * Unit tests for DatabaseQueryOptimizerPlugin
 */
class DatabaseQueryOptimizerPluginTest extends TestCase
{
    private DatabaseQueryOptimizerPlugin $plugin;
    ...
    protected function setUp(): void
    {
        ...
        $this->plugin = new DatabaseQueryOptimizerPlugin($this->container, '/fake/path');
    }
    
    public function testPluginInstantiation(): void
    {
        $this->assertInstanceOf(DatabaseQueryOptimizerPlugin::class, $this->plugin);
    }
