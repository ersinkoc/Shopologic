...
namespace Tests\Integration\dynamic-inventory-forecasting;

use PHPUnit\Framework\TestCase;

/**
 * Integration tests for dynamic-inventory-forecasting plugin
 */
class dynamic-inventory-forecastingIntegrationTest extends TestCase
{
