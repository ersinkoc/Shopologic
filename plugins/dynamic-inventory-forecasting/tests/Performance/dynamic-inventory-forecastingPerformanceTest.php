...
namespace Tests\Performance\dynamic-inventory-forecasting;

use PHPUnit\Framework\TestCase;

/**
 * Performance tests for dynamic-inventory-forecasting plugin
 */
class dynamic-inventory-forecastingPerformanceTest extends TestCase
{
