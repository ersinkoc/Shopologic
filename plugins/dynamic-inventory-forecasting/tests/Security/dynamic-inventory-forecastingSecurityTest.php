...
namespace Tests\Security\dynamic-inventory-forecasting;

use PHPUnit\Framework\TestCase;

/**
 * Security tests for dynamic-inventory-forecasting plugin
 */
class dynamic-inventory-forecastingSecurityTest extends TestCase
{
