...
namespace Tests\Unit\dynamic-inventory-forecasting;

use PHPUnit\Framework\TestCase;
use Shopologic\Plugins\DynamicInventoryForecasting\DynamicInventoryForecastingPlugin;
use Shopologic\Core\Container\Container;

/**
 * Unit tests for DynamicInventoryForecastingPlugin
 */
class DynamicInventoryForecastingPluginTest extends TestCase
{
    private DynamicInventoryForecastingPlugin $plugin;
    ...
    protected function setUp(): void
    {
        ...
        $this->plugin = new DynamicInventoryForecastingPlugin($this->container, '/fake/path');
    }
    
    public function testPluginInstantiation(): void
    {
        $this->assertInstanceOf(DynamicInventoryForecastingPlugin::class, $this->plugin);
    }
