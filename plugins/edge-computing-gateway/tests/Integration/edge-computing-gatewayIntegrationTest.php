...
namespace Tests\Integration\edge-computing-gateway;

use PHPUnit\Framework\TestCase;

/**
 * Integration tests for edge-computing-gateway plugin
 */
class edge-computing-gatewayIntegrationTest extends TestCase
{
