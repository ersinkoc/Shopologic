...
namespace Tests\Performance\edge-computing-gateway;

use PHPUnit\Framework\TestCase;

/**
 * Performance tests for edge-computing-gateway plugin
 */
class edge-computing-gatewayPerformanceTest extends TestCase
{
