...
namespace Tests\Security\edge-computing-gateway;

use PHPUnit\Framework\TestCase;

/**
 * Security tests for edge-computing-gateway plugin
 */
class edge-computing-gatewaySecurityTest extends TestCase
{
