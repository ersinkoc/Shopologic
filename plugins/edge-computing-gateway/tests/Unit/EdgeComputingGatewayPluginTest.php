...
namespace Tests\Unit\edge-computing-gateway;

use PHPUnit\Framework\TestCase;
use Shopologic\Plugins\EdgeComputingGateway\EdgeComputingGatewayPlugin;
use Shopologic\Core\Container\Container;

/**
 * Unit tests for EdgeComputingGatewayPlugin
 */
class EdgeComputingGatewayPluginTest extends TestCase
{
    private EdgeComputingGatewayPlugin $plugin;
    ...
    protected function setUp(): void
    {
        ...
        $this->plugin = new EdgeComputingGatewayPlugin($this->container, '/fake/path');
    }
    
    public function testPluginInstantiation(): void
    {
        $this->assertInstanceOf(EdgeComputingGatewayPlugin::class, $this->plugin);
    }
