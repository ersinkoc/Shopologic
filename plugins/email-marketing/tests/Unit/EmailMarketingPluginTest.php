...
namespace Tests\Unit\email-marketing;

use PHPUnit\Framework\TestCase;
use Shopologic\Plugins\EmailMarketing\EmailMarketingPlugin;
use Shopologic\Core\Container\Container;

/**
 * Unit tests for EmailMarketingPlugin
 */
class EmailMarketingPluginTest extends TestCase
{
    private EmailMarketingPlugin $plugin;
    ...
    protected function setUp(): void
    {
        ...
        $this->plugin = new EmailMarketingPlugin($this->container, '/fake/path');
    }
    
    public function testPluginInstantiation(): void
    {
        $this->assertInstanceOf(EmailMarketingPlugin::class, $this->plugin);
    }
