...
namespace Tests\Integration\enterprise-security-compliance;

use PHPUnit\Framework\TestCase;

/**
 * Integration tests for enterprise-security-compliance plugin
 */
class enterprise-security-complianceIntegrationTest extends TestCase
{
