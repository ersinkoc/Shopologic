...
namespace Tests\Performance\enterprise-security-compliance;

use PHPUnit\Framework\TestCase;

/**
 * Performance tests for enterprise-security-compliance plugin
 */
class enterprise-security-compliancePerformanceTest extends TestCase
{
