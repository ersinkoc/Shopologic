...
namespace Tests\Security\enterprise-security-compliance;

use PHPUnit\Framework\TestCase;

/**
 * Security tests for enterprise-security-compliance plugin
 */
class enterprise-security-complianceSecurityTest extends TestCase
{
