...
namespace Tests\Unit\enterprise-security-compliance;

use PHPUnit\Framework\TestCase;
use Shopologic\Plugins\EnterpriseSecurityCompliance\EnterpriseSecurityCompliancePlugin;
use Shopologic\Core\Container\Container;

/**
 * Unit tests for EnterpriseSecurityCompliancePlugin
 */
class EnterpriseSecurityCompliancePluginTest extends TestCase
{
    private EnterpriseSecurityCompliancePlugin $plugin;
    ...
    protected function setUp(): void
    {
        ...
        $this->plugin = new EnterpriseSecurityCompliancePlugin($this->container, '/fake/path');
    }
    
    public function testPluginInstantiation(): void
    {
        $this->assertInstanceOf(EnterpriseSecurityCompliancePlugin::class, $this->plugin);
    }
