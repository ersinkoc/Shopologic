...
namespace Tests\Integration\enterprise-supply-chain-management;

use PHPUnit\Framework\TestCase;

/**
 * Integration tests for enterprise-supply-chain-management plugin
 */
class enterprise-supply-chain-managementIntegrationTest extends TestCase
{
