...
namespace Tests\Performance\enterprise-supply-chain-management;

use PHPUnit\Framework\TestCase;

/**
 * Performance tests for enterprise-supply-chain-management plugin
 */
class enterprise-supply-chain-managementPerformanceTest extends TestCase
{
