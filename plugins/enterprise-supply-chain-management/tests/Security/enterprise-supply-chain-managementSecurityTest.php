...
namespace Tests\Security\enterprise-supply-chain-management;

use PHPUnit\Framework\TestCase;

/**
 * Security tests for enterprise-supply-chain-management plugin
 */
class enterprise-supply-chain-managementSecurityTest extends TestCase
{
