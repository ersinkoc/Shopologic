...
namespace Tests\Unit\enterprise-supply-chain-management;

use PHPUnit\Framework\TestCase;
use Shopologic\Plugins\EnterpriseSupplyChainManagement\EnterpriseSupplyChainManagementPlugin;
use Shopologic\Core\Container\Container;

/**
 * Unit tests for EnterpriseSupplyChainManagementPlugin
 */
class EnterpriseSupplyChainManagementPluginTest extends TestCase
{
    private EnterpriseSupplyChainManagementPlugin $plugin;
    ...
    protected function setUp(): void
    {
        ...
        $this->plugin = new EnterpriseSupplyChainManagementPlugin($this->container, '/fake/path');
    }
    
    public function testPluginInstantiation(): void
    {
        $this->assertInstanceOf(EnterpriseSupplyChainManagementPlugin::class, $this->plugin);
    }
