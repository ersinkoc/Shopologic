...
namespace Tests\Unit\event-sourcing;

use PHPUnit\Framework\TestCase;
use Shopologic\Plugins\EventSourcing\EventSourcingPlugin;
use Shopologic\Core\Container\Container;

/**
 * Unit tests for EventSourcingPlugin
 */
class EventSourcingPluginTest extends TestCase
{
    private EventSourcingPlugin $plugin;
    ...
    protected function setUp(): void
    {
        ...
        $this->plugin = new EventSourcingPlugin($this->container, '/fake/path');
    }
    
    public function testPluginInstantiation(): void
    {
        $this->assertInstanceOf(EventSourcingPlugin::class, $this->plugin);
    }
