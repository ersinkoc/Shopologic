...
namespace Tests\Integration\feature-flag-manager;

use PHPUnit\Framework\TestCase;

/**
 * Integration tests for feature-flag-manager plugin
 */
class feature-flag-managerIntegrationTest extends TestCase
{
