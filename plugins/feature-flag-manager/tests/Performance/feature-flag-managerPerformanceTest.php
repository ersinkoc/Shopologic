...
namespace Tests\Performance\feature-flag-manager;

use PHPUnit\Framework\TestCase;

/**
 * Performance tests for feature-flag-manager plugin
 */
class feature-flag-managerPerformanceTest extends TestCase
{
