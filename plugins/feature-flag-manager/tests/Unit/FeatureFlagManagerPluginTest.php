...
namespace Tests\Unit\feature-flag-manager;

use PHPUnit\Framework\TestCase;
use Shopologic\Plugins\FeatureFlagManager\FeatureFlagManagerPlugin;
use Shopologic\Core\Container\Container;

/**
 * Unit tests for FeatureFlagManagerPlugin
 */
class FeatureFlagManagerPluginTest extends TestCase
{
    private FeatureFlagManagerPlugin $plugin;
    ...
    protected function setUp(): void
    {
        ...
        $this->plugin = new FeatureFlagManagerPlugin($this->container, '/fake/path');
    }
    
    public function testPluginInstantiation(): void
    {
        $this->assertInstanceOf(FeatureFlagManagerPlugin::class, $this->plugin);
    }
