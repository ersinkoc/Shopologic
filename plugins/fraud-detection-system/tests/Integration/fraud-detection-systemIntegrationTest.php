...
namespace Tests\Integration\fraud-detection-system;

use PHPUnit\Framework\TestCase;

/**
 * Integration tests for fraud-detection-system plugin
 */
class fraud-detection-systemIntegrationTest extends TestCase
{
