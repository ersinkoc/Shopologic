...
namespace Tests\Performance\fraud-detection-system;

use PHPUnit\Framework\TestCase;

/**
 * Performance tests for fraud-detection-system plugin
 */
class fraud-detection-systemPerformanceTest extends TestCase
{
