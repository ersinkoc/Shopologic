...
namespace Tests\Security\fraud-detection-system;

use PHPUnit\Framework\TestCase;

/**
 * Security tests for fraud-detection-system plugin
 */
class fraud-detection-systemSecurityTest extends TestCase
{
