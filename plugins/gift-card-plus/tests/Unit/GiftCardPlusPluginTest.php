...
namespace Tests\Unit\gift-card-plus;

use PHPUnit\Framework\TestCase;
use Shopologic\Plugins\GiftCardPlus\GiftCardPlusPlugin;
use Shopologic\Core\Container\Container;

/**
 * Unit tests for GiftCardPlusPlugin
 */
class GiftCardPlusPluginTest extends TestCase
{
    private GiftCardPlusPlugin $plugin;
    ...
    protected function setUp(): void
    {
        ...
        $this->plugin = new GiftCardPlusPlugin($this->container, '/fake/path');
    }
    
    public function testPluginInstantiation(): void
    {
        $this->assertInstanceOf(GiftCardPlusPlugin::class, $this->plugin);
    }
