...
namespace Tests\Integration\graphql-schema-builder;

use PHPUnit\Framework\TestCase;

/**
 * Integration tests for graphql-schema-builder plugin
 */
class graphql-schema-builderIntegrationTest extends TestCase
{
