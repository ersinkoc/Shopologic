...
namespace Tests\Performance\graphql-schema-builder;

use PHPUnit\Framework\TestCase;

/**
 * Performance tests for graphql-schema-builder plugin
 */
class graphql-schema-builderPerformanceTest extends TestCase
{
