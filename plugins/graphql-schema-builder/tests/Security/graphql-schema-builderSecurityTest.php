...
namespace Tests\Security\graphql-schema-builder;

use PHPUnit\Framework\TestCase;

/**
 * Security tests for graphql-schema-builder plugin
 */
class graphql-schema-builderSecurityTest extends TestCase
{
