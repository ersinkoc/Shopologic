...
namespace Tests\Unit\graphql-schema-builder;

use PHPUnit\Framework\TestCase;
use Shopologic\Plugins\GraphqlSchemaBuilder\GraphqlSchemaBuilderPlugin;
use Shopologic\Core\Container\Container;

/**
 * Unit tests for GraphqlSchemaBuilderPlugin
 */
class GraphqlSchemaBuilderPluginTest extends TestCase
{
    private GraphqlSchemaBuilderPlugin $plugin;
    ...
    protected function setUp(): void
    {
        ...
        $this->plugin = new GraphqlSchemaBuilderPlugin($this->container, '/fake/path');
    }
    
    public function testPluginInstantiation(): void
    {
        $this->assertInstanceOf(GraphqlSchemaBuilderPlugin::class, $this->plugin);
    }
