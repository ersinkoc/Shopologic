...
namespace Tests\Integration\headless-commerce-api;

use PHPUnit\Framework\TestCase;

/**
 * Integration tests for headless-commerce-api plugin
 */
class headless-commerce-apiIntegrationTest extends TestCase
{
