...
namespace Tests\Performance\headless-commerce-api;

use PHPUnit\Framework\TestCase;

/**
 * Performance tests for headless-commerce-api plugin
 */
class headless-commerce-apiPerformanceTest extends TestCase
{
