...
namespace Tests\Unit\headless-commerce-api;

use PHPUnit\Framework\TestCase;
use Shopologic\Plugins\HeadlessCommerceApi\HeadlessCommerceApiPlugin;
use Shopologic\Core\Container\Container;

/**
 * Unit tests for HeadlessCommerceApiPlugin
 */
class HeadlessCommerceApiPluginTest extends TestCase
{
    private HeadlessCommerceApiPlugin $plugin;
    ...
    protected function setUp(): void
    {
        ...
        $this->plugin = new HeadlessCommerceApiPlugin($this->container, '/fake/path');
    }
    
    public function testPluginInstantiation(): void
    {
        $this->assertInstanceOf(HeadlessCommerceApiPlugin::class, $this->plugin);
    }
