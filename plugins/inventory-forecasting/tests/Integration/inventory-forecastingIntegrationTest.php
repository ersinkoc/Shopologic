...
namespace Tests\Integration\inventory-forecasting;

use PHPUnit\Framework\TestCase;

/**
 * Integration tests for inventory-forecasting plugin
 */
class inventory-forecastingIntegrationTest extends TestCase
{
