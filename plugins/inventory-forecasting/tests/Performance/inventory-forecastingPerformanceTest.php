...
namespace Tests\Performance\inventory-forecasting;

use PHPUnit\Framework\TestCase;

/**
 * Performance tests for inventory-forecasting plugin
 */
class inventory-forecastingPerformanceTest extends TestCase
{
