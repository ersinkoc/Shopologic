...
namespace Tests\Unit\inventory-forecasting;

use PHPUnit\Framework\TestCase;
use Shopologic\Plugins\InventoryForecasting\InventoryForecastingPlugin;
use Shopologic\Core\Container\Container;

/**
 * Unit tests for InventoryForecastingPlugin
 */
class InventoryForecastingPluginTest extends TestCase
{
    private InventoryForecastingPlugin $plugin;
    ...
    protected function setUp(): void
    {
        ...
        $this->plugin = new InventoryForecastingPlugin($this->container, '/fake/path');
    }
    
    public function testPluginInstantiation(): void
    {
        $this->assertInstanceOf(InventoryForecastingPlugin::class, $this->plugin);
    }
