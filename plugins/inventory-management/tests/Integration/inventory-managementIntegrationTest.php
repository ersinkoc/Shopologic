...
namespace Tests\Integration\inventory-management;

use PHPUnit\Framework\TestCase;

/**
 * Integration tests for inventory-management plugin
 */
class inventory-managementIntegrationTest extends TestCase
{
