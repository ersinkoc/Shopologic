...
namespace Tests\Performance\inventory-management;

use PHPUnit\Framework\TestCase;

/**
 * Performance tests for inventory-management plugin
 */
class inventory-managementPerformanceTest extends TestCase
{
