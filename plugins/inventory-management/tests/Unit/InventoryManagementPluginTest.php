...
namespace Tests\Unit\inventory-management;

use PHPUnit\Framework\TestCase;
use Shopologic\Plugins\InventoryManagement\InventoryManagementPlugin;
use Shopologic\Core\Container\Container;

/**
 * Unit tests for InventoryManagementPlugin
 */
class InventoryManagementPluginTest extends TestCase
{
    private InventoryManagementPlugin $plugin;
    ...
    protected function setUp(): void
    {
        ...
        $this->plugin = new InventoryManagementPlugin($this->container, '/fake/path');
    }
    
    public function testPluginInstantiation(): void
    {
        $this->assertInstanceOf(InventoryManagementPlugin::class, $this->plugin);
    }
