...
namespace Tests\Unit\journey-analytics;

use PHPUnit\Framework\TestCase;
use Shopologic\Plugins\JourneyAnalytics\JourneyAnalyticsPlugin;
use Shopologic\Core\Container\Container;

/**
 * Unit tests for JourneyAnalyticsPlugin
 */
class JourneyAnalyticsPluginTest extends TestCase
{
    private JourneyAnalyticsPlugin $plugin;
    ...
    protected function setUp(): void
    {
        ...
        $this->plugin = new JourneyAnalyticsPlugin($this->container, '/fake/path');
    }
    
    public function testPluginInstantiation(): void
    {
        $this->assertInstanceOf(JourneyAnalyticsPlugin::class, $this->plugin);
    }
