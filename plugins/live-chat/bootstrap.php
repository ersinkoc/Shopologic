...
/**
 * Live Chat Support Plugin Bootstrap
 * 
 * @package Shopologic\Plugins\LiveChat
 * @version 1.0.0
 */
...
class LiveChatPlugin extends AbstractPlugin
{
    /**
     * Plugin activation
     */
...
return function(Container $container, string $pluginPath) {
    return new LiveChatPlugin($container, $pluginPath);
};