...
namespace Tests\Unit\live-chat;

use PHPUnit\Framework\TestCase;
use Shopologic\Plugins\LiveChat\LiveChatPlugin;
use Shopologic\Core\Container\Container;

/**
 * Unit tests for LiveChatPlugin
 */
class LiveChatPluginTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->plugin = new LiveChatPlugin($this->container, '/fake/path');
    }
    
    public function testPluginInstantiation(): void
    {
        $this->assertInstanceOf(LiveChatPlugin::class, $this->plugin);
    }
