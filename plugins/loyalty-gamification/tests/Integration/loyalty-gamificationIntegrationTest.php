...
namespace Tests\Integration\loyalty-gamification;

use PHPUnit\Framework\TestCase;

/**
 * Integration tests for loyalty-gamification plugin
 */
class loyalty-gamificationIntegrationTest extends TestCase
{
