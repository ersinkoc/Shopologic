...
namespace Tests\Performance\loyalty-gamification;

use PHPUnit\Framework\TestCase;

/**
 * Performance tests for loyalty-gamification plugin
 */
class loyalty-gamificationPerformanceTest extends TestCase
{
