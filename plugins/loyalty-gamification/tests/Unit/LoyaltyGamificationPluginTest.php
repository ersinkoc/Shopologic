...
namespace Tests\Unit\loyalty-gamification;

use PHPUnit\Framework\TestCase;
use Shopologic\Plugins\LoyaltyGamification\LoyaltyGamificationPlugin;
use Shopologic\Core\Container\Container;

/**
 * Unit tests for LoyaltyGamificationPlugin
 */
class LoyaltyGamificationPluginTest extends TestCase
{
    private LoyaltyGamificationPlugin $plugin;
    ...
    protected function setUp(): void
    {
        ...
        $this->plugin = new LoyaltyGamificationPlugin($this->container, '/fake/path');
    }
    
    public function testPluginInstantiation(): void
    {
        $this->assertInstanceOf(LoyaltyGamificationPlugin::class, $this->plugin);
    }
