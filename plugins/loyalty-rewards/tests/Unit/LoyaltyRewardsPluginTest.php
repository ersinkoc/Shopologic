...
namespace Tests\Unit\loyalty-rewards;

use PHPUnit\Framework\TestCase;
use Shopologic\Plugins\LoyaltyRewards\LoyaltyRewardsPlugin;
use Shopologic\Core\Container\Container;

/**
 * Unit tests for LoyaltyRewardsPlugin
 */
class LoyaltyRewardsPluginTest extends TestCase
{
    private LoyaltyRewardsPlugin $plugin;
    ...
    protected function setUp(): void
    {
        ...
        $this->plugin = new LoyaltyRewardsPlugin($this->container, '/fake/path');
    }
    
    public function testPluginInstantiation(): void
    {
        $this->assertInstanceOf(LoyaltyRewardsPlugin::class, $this->plugin);
    }
