...
namespace Tests\Integration\microservices-manager;

use PHPUnit\Framework\TestCase;

/**
 * Integration tests for microservices-manager plugin
 */
class microservices-managerIntegrationTest extends TestCase
{
