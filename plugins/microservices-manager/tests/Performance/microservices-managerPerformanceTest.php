...
namespace Tests\Performance\microservices-manager;

use PHPUnit\Framework\TestCase;

/**
 * Performance tests for microservices-manager plugin
 */
class microservices-managerPerformanceTest extends TestCase
{
