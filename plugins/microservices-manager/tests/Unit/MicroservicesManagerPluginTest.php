...
namespace Tests\Unit\microservices-manager;

use PHPUnit\Framework\TestCase;
use Shopologic\Plugins\MicroservicesManager\MicroservicesManagerPlugin;
use Shopologic\Core\Container\Container;

/**
 * Unit tests for MicroservicesManagerPlugin
 */
class MicroservicesManagerPluginTest extends TestCase
{
    private MicroservicesManagerPlugin $plugin;
    ...
    protected function setUp(): void
    {
        ...
        $this->plugin = new MicroservicesManagerPlugin($this->container, '/fake/path');
    }
    
    public function testPluginInstantiation(): void
    {
        $this->assertInstanceOf(MicroservicesManagerPlugin::class, $this->plugin);
    }
