...
namespace Tests\Performance\ml-model-deployment;

use PHPUnit\Framework\TestCase;

/**
 * Performance tests for ml-model-deployment plugin
 */
class ml-model-deploymentPerformanceTest extends TestCase
{
