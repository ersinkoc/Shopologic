...
namespace Tests\Unit\ml-model-deployment;

use PHPUnit\Framework\TestCase;
use Shopologic\Plugins\MlModelDeployment\MlModelDeploymentPlugin;
use Shopologic\Core\Container\Container;

/**
 * Unit tests for MlModelDeploymentPlugin
 */
class MlModelDeploymentPluginTest extends TestCase
{
    private MlModelDeploymentPlugin $plugin;
    ...
    protected function setUp(): void
    {
        ...
        $this->plugin = new MlModelDeploymentPlugin($this->container, '/fake/path');
    }
    
    public function testPluginInstantiation(): void
    {
        $this->assertInstanceOf(MlModelDeploymentPlugin::class, $this->plugin);
    }
