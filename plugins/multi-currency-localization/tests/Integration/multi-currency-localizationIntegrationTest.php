...
namespace Tests\Integration\multi-currency-localization;

use PHPUnit\Framework\TestCase;

/**
 * Integration tests for multi-currency-localization plugin
 */
class multi-currency-localizationIntegrationTest extends TestCase
{
