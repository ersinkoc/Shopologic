...
namespace Tests\Performance\multi-currency-localization;

use PHPUnit\Framework\TestCase;

/**
 * Performance tests for multi-currency-localization plugin
 */
class multi-currency-localizationPerformanceTest extends TestCase
{
