...
namespace Tests\Security\multi-currency-localization;

use PHPUnit\Framework\TestCase;

/**
 * Security tests for multi-currency-localization plugin
 */
class multi-currency-localizationSecurityTest extends TestCase
{
