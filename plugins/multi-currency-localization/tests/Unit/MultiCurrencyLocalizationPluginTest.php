...
namespace Tests\Unit\multi-currency-localization;

use PHPUnit\Framework\TestCase;
use Shopologic\Plugins\MultiCurrencyLocalization\MultiCurrencyLocalizationPlugin;
use Shopologic\Core\Container\Container;

/**
 * Unit tests for MultiCurrencyLocalizationPlugin
 */
class MultiCurrencyLocalizationPluginTest extends TestCase
{
    private MultiCurrencyLocalizationPlugin $plugin;
    ...
    protected function setUp(): void
    {
        ...
        $this->plugin = new MultiCurrencyLocalizationPlugin($this->container, '/fake/path');
    }
    
    public function testPluginInstantiation(): void
    {
        $this->assertInstanceOf(MultiCurrencyLocalizationPlugin::class, $this->plugin);
    }
