...
namespace Tests\Unit\multi-currency;

use PHPUnit\Framework\TestCase;
use Shopologic\Plugins\MultiCurrency\MultiCurrencyPlugin;
use Shopologic\Core\Container\Container;

/**
 * Unit tests for MultiCurrencyPlugin
 */
class MultiCurrencyPluginTest extends TestCase
{
    private MultiCurrencyPlugin $plugin;
    ...
    protected function setUp(): void
    {
        ...
        $this->plugin = new MultiCurrencyPlugin($this->container, '/fake/path');
    }
    
    public function testPluginInstantiation(): void
    {
        $this->assertInstanceOf(MultiCurrencyPlugin::class, $this->plugin);
    }
