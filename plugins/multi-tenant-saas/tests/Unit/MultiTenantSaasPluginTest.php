...
namespace Tests\Unit\multi-tenant-saas;

use PHPUnit\Framework\TestCase;
use Shopologic\Plugins\MultiTenantSaas\MultiTenantSaasPlugin;
use Shopologic\Core\Container\Container;

/**
 * Unit tests for MultiTenantSaasPlugin
 */
class MultiTenantSaasPluginTest extends TestCase
{
    private MultiTenantSaasPlugin $plugin;
    ...
    protected function setUp(): void
    {
        ...
        $this->plugin = new MultiTenantSaasPlugin($this->container, '/fake/path');
    }
    
    public function testPluginInstantiation(): void
    {
        $this->assertInstanceOf(MultiTenantSaasPlugin::class, $this->plugin);
    }
