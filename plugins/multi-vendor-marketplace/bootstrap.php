...
/**
 * Multi-Vendor Marketplace Plugin Bootstrap
 * 
 * @package Shopologic\Plugins\MultiVendorMarketplace
 * @version 1.0.0
 */
...
return function(Container $container, string $pluginPath) {
    return new MultiVendorMarketplacePlugin($container, $pluginPath);
};