...
namespace Tests\Integration\multi-vendor-marketplace;

use PHPUnit\Framework\TestCase;

/**
 * Integration tests for multi-vendor-marketplace plugin
 */
class multi-vendor-marketplaceIntegrationTest extends TestCase
{
