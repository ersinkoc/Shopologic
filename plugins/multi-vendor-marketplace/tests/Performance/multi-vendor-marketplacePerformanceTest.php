...
namespace Tests\Performance\multi-vendor-marketplace;

use PHPUnit\Framework\TestCase;

/**
 * Performance tests for multi-vendor-marketplace plugin
 */
class multi-vendor-marketplacePerformanceTest extends TestCase
{
