...
namespace Tests\Security\multi-vendor-marketplace;

use PHPUnit\Framework\TestCase;

/**
 * Security tests for multi-vendor-marketplace plugin
 */
class multi-vendor-marketplaceSecurityTest extends TestCase
{
