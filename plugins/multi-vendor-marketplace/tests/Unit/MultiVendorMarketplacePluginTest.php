...
namespace Tests\Unit\multi-vendor-marketplace;

use PHPUnit\Framework\TestCase;
use Shopologic\Plugins\MultiVendorMarketplace\MultiVendorMarketplacePlugin;
use Shopologic\Core\Container\Container;

/**
 * Unit tests for MultiVendorMarketplacePlugin
 */
class MultiVendorMarketplacePluginTest extends TestCase
{
    private MultiVendorMarketplacePlugin $plugin;
    ...
    protected function setUp(): void
    {
        ...
        $this->plugin = new MultiVendorMarketplacePlugin($this->container, '/fake/path');
    }
    
    public function testPluginInstantiation(): void
    {
        $this->assertInstanceOf(MultiVendorMarketplacePlugin::class, $this->plugin);
    }
