...
namespace Tests\Integration\omnichannel-integration-hub;

use PHPUnit\Framework\TestCase;

/**
 * Integration tests for omnichannel-integration-hub plugin
 */
class omnichannel-integration-hubIntegrationTest extends TestCase
{
