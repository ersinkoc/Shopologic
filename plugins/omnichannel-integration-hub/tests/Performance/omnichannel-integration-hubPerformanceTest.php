...
namespace Tests\Performance\omnichannel-integration-hub;

use PHPUnit\Framework\TestCase;

/**
 * Performance tests for omnichannel-integration-hub plugin
 */
class omnichannel-integration-hubPerformanceTest extends TestCase
{
