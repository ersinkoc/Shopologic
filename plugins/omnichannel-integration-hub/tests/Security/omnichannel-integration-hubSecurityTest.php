...
namespace Tests\Security\omnichannel-integration-hub;

use PHPUnit\Framework\TestCase;

/**
 * Security tests for omnichannel-integration-hub plugin
 */
class omnichannel-integration-hubSecurityTest extends TestCase
{
