...
namespace Tests\Unit\omnichannel-integration-hub;

use PHPUnit\Framework\TestCase;
use Shopologic\Plugins\OmnichannelIntegrationHub\OmnichannelIntegrationHubPlugin;
use Shopologic\Core\Container\Container;

/**
 * Unit tests for OmnichannelIntegrationHubPlugin
 */
class OmnichannelIntegrationHubPluginTest extends TestCase
{
    private OmnichannelIntegrationHubPlugin $plugin;
    ...
    protected function setUp(): void
    {
        ...
        $this->plugin = new OmnichannelIntegrationHubPlugin($this->container, '/fake/path');
    }
    
    public function testPluginInstantiation(): void
    {
        $this->assertInstanceOf(OmnichannelIntegrationHubPlugin::class, $this->plugin);
    }
