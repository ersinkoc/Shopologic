...
namespace Tests\Unit\payment-paypal;

use PHPUnit\Framework\TestCase;
use Shopologic\Plugins\PaymentPaypal\PaymentPaypalPlugin;
use Shopologic\Core\Container\Container;

/**
 * Unit tests for PaymentPaypalPlugin
 */
class PaymentPaypalPluginTest extends TestCase
{
    private PaymentPaypalPlugin $plugin;
    ...
    protected function setUp(): void
    {
        ...
        $this->plugin = new PaymentPaypalPlugin($this->container, '/fake/path');
    }
    
    public function testPluginInstantiation(): void
    {
        $this->assertInstanceOf(PaymentPaypalPlugin::class, $this->plugin);
    }
