...
namespace Tests\Unit\payment-stripe;

use PHPUnit\Framework\TestCase;
use Shopologic\Plugins\PaymentStripe\PaymentStripePlugin;
use Shopologic\Core\Container\Container;

/**
 * Unit tests for PaymentStripePlugin
 */
class PaymentStripePluginTest extends TestCase
{
    private PaymentStripePlugin $plugin;
    ...
    protected function setUp(): void
    {
        ...
        $this->plugin = new PaymentStripePlugin($this->container, '/fake/path');
    }
    
    public function testPluginInstantiation(): void
    {
        $this->assertInstanceOf(PaymentStripePlugin::class, $this->plugin);
    }
