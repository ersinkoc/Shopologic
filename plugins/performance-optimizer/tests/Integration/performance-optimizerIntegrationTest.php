...
namespace Tests\Integration\performance-optimizer;

use PHPUnit\Framework\TestCase;

/**
 * Integration tests for performance-optimizer plugin
 */
class performance-optimizerIntegrationTest extends TestCase
{
