...
namespace Tests\Performance\performance-optimizer;

use PHPUnit\Framework\TestCase;

/**
 * Performance tests for performance-optimizer plugin
 */
class performance-optimizerPerformanceTest extends TestCase
{
