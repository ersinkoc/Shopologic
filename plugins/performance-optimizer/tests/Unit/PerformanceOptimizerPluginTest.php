...
namespace Tests\Unit\performance-optimizer;

use PHPUnit\Framework\TestCase;
use Shopologic\Plugins\PerformanceOptimizer\PerformanceOptimizerPlugin;
use Shopologic\Core\Container\Container;

/**
 * Unit tests for PerformanceOptimizerPlugin
 */
class PerformanceOptimizerPluginTest extends TestCase
{
    private PerformanceOptimizerPlugin $plugin;
    ...
    protected function setUp(): void
    {
        ...
        $this->plugin = new PerformanceOptimizerPlugin($this->container, '/fake/path');
    }
    
    public function testPluginInstantiation(): void
    {
        $this->assertInstanceOf(PerformanceOptimizerPlugin::class, $this->plugin);
    }
