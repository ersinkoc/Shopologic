...
namespace Tests\Integration\performance-profiler;

use PHPUnit\Framework\TestCase;

/**
 * Integration tests for performance-profiler plugin
 */
class performance-profilerIntegrationTest extends TestCase
{
