...
namespace Tests\Performance\performance-profiler;

use PHPUnit\Framework\TestCase;

/**
 * Performance tests for performance-profiler plugin
 */
class performance-profilerPerformanceTest extends TestCase
{
