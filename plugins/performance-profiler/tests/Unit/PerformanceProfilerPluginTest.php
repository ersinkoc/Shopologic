...
namespace Tests\Unit\performance-profiler;

use PHPUnit\Framework\TestCase;
use Shopologic\Plugins\PerformanceProfiler\PerformanceProfilerPlugin;
use Shopologic\Core\Container\Container;

/**
 * Unit tests for PerformanceProfilerPlugin
 */
class PerformanceProfilerPluginTest extends TestCase
{
    private PerformanceProfilerPlugin $plugin;
    ...
    protected function setUp(): void
    {
        ...
        $this->plugin = new PerformanceProfilerPlugin($this->container, '/fake/path');
    }
    
    public function testPluginInstantiation(): void
    {
        $this->assertInstanceOf(PerformanceProfilerPlugin::class, $this->plugin);
    }
