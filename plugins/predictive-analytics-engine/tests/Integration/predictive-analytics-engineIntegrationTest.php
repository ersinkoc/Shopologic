...
namespace Tests\Integration\predictive-analytics-engine;

use PHPUnit\Framework\TestCase;

/**
 * Integration tests for predictive-analytics-engine plugin
 */
class predictive-analytics-engineIntegrationTest extends TestCase
{
