...
namespace Tests\Performance\predictive-analytics-engine;

use PHPUnit\Framework\TestCase;

/**
 * Performance tests for predictive-analytics-engine plugin
 */
class predictive-analytics-enginePerformanceTest extends TestCase
{
