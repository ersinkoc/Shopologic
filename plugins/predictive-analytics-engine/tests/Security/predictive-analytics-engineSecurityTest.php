...
namespace Tests\Security\predictive-analytics-engine;

use PHPUnit\Framework\TestCase;

/**
 * Security tests for predictive-analytics-engine plugin
 */
class predictive-analytics-engineSecurityTest extends TestCase
{
