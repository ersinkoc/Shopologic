...
namespace Tests\Unit\predictive-analytics-engine;

use PHPUnit\Framework\TestCase;
use Shopologic\Plugins\PredictiveAnalyticsEngine\PredictiveAnalyticsEnginePlugin;
use Shopologic\Core\Container\Container;

/**
 * Unit tests for PredictiveAnalyticsEnginePlugin
 */
class PredictiveAnalyticsEnginePluginTest extends TestCase
{
    private PredictiveAnalyticsEnginePlugin $plugin;
    ...
    protected function setUp(): void
    {
        ...
        $this->plugin = new PredictiveAnalyticsEnginePlugin($this->container, '/fake/path');
    }
    
    public function testPluginInstantiation(): void
    {
        $this->assertInstanceOf(PredictiveAnalyticsEnginePlugin::class, $this->plugin);
    }
