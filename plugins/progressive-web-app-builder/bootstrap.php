...
/**
 * progressive-web-app-builder Plugin Bootstrap
 * 
 * @package Shopologic\Plugins\ProgressiveWebAppBuilder
 * @version 1.0.0
 */
...
return function(Container $container, string $pluginPath) {
    return new ProgressiveWebAppBuilderPlugin($container, $pluginPath);
};