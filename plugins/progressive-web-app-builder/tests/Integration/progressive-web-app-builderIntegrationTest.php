...
namespace Tests\Integration\progressive-web-app-builder;

use PHPUnit\Framework\TestCase;

/**
 * Integration tests for progressive-web-app-builder plugin
 */
class progressive-web-app-builderIntegrationTest extends TestCase
{
