...
namespace Tests\Performance\progressive-web-app-builder;

use PHPUnit\Framework\TestCase;

/**
 * Performance tests for progressive-web-app-builder plugin
 */
class progressive-web-app-builderPerformanceTest extends TestCase
{
