...
namespace Tests\Security\progressive-web-app-builder;

use PHPUnit\Framework\TestCase;

/**
 * Security tests for progressive-web-app-builder plugin
 */
class progressive-web-app-builderSecurityTest extends TestCase
{
