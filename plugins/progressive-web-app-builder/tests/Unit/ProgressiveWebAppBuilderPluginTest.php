...
namespace Tests\Unit\progressive-web-app-builder;

use PHPUnit\Framework\TestCase;
use Shopologic\Plugins\ProgressiveWebAppBuilder\ProgressiveWebAppBuilderPlugin;
use Shopologic\Core\Container\Container;

/**
 * Unit tests for ProgressiveWebAppBuilderPlugin
 */
class ProgressiveWebAppBuilderPluginTest extends TestCase
{
    private ProgressiveWebAppBuilderPlugin $plugin;
    ...
    protected function setUp(): void
    {
        ...
        $this->plugin = new ProgressiveWebAppBuilderPlugin($this->container, '/fake/path');
    }
    
    public function testPluginInstantiation(): void
    {
        $this->assertInstanceOf(ProgressiveWebAppBuilderPlugin::class, $this->plugin);
    }
