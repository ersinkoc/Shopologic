...
namespace Tests\Unit\pwa-enhancer;

use PHPUnit\Framework\TestCase;
use Shopologic\Plugins\PwaEnhancer\PwaEnhancerPlugin;
use Shopologic\Core\Container\Container;

/**
 * Unit tests for PwaEnhancerPlugin
 */
class PwaEnhancerPluginTest extends TestCase
{
    private PwaEnhancerPlugin $plugin;
    ...
    protected function setUp(): void
    {
        ...
        $this->plugin = new PwaEnhancerPlugin($this->container, '/fake/path');
    }
    
    public function testPluginInstantiation(): void
    {
        $this->assertInstanceOf(PwaEnhancerPlugin::class, $this->plugin);
    }
