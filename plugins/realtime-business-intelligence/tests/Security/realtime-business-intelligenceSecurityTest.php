...
namespace Tests\Security\realtime-business-intelligence;

use PHPUnit\Framework\TestCase;

/**
 * Security tests for realtime-business-intelligence plugin
 */
class realtime-business-intelligenceSecurityTest extends TestCase
{
