...
namespace Tests\Unit\realtime-business-intelligence;

use PHPUnit\Framework\TestCase;
use Shopologic\Plugins\RealtimeBusinessIntelligence\RealtimeBusinessIntelligencePlugin;
use Shopologic\Core\Container\Container;

/**
 * Unit tests for RealtimeBusinessIntelligencePlugin
 */
class RealtimeBusinessIntelligencePluginTest extends TestCase
{
    private RealtimeBusinessIntelligencePlugin $plugin;
    ...
    protected function setUp(): void
    {
        ...
        $this->plugin = new RealtimeBusinessIntelligencePlugin($this->container, '/fake/path');
    }
    
    public function testPluginInstantiation(): void
    {
        $this->assertInstanceOf(RealtimeBusinessIntelligencePlugin::class, $this->plugin);
    }
