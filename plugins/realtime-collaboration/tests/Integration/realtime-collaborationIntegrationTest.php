...
namespace Tests\Integration\realtime-collaboration;

use PHPUnit\Framework\TestCase;

/**
 * Integration tests for realtime-collaboration plugin
 */
class realtime-collaborationIntegrationTest extends TestCase
{
