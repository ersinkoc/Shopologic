...
namespace Tests\Performance\realtime-collaboration;

use PHPUnit\Framework\TestCase;

/**
 * Performance tests for realtime-collaboration plugin
 */
class realtime-collaborationPerformanceTest extends TestCase
{
