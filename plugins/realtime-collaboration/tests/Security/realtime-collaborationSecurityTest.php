...
namespace Tests\Security\realtime-collaboration;

use PHPUnit\Framework\TestCase;

/**
 * Security tests for realtime-collaboration plugin
 */
class realtime-collaborationSecurityTest extends TestCase
{
