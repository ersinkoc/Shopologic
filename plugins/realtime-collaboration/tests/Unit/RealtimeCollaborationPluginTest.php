...
namespace Tests\Unit\realtime-collaboration;

use PHPUnit\Framework\TestCase;
use Shopologic\Plugins\RealtimeCollaboration\RealtimeCollaborationPlugin;
use Shopologic\Core\Container\Container;

/**
 * Unit tests for RealtimeCollaborationPlugin
 */
class RealtimeCollaborationPluginTest extends TestCase
{
    private RealtimeCollaborationPlugin $plugin;
    ...
    protected function setUp(): void
    {
        ...
        $this->plugin = new RealtimeCollaborationPlugin($this->container, '/fake/path');
    }
    
    public function testPluginInstantiation(): void
    {
        $this->assertInstanceOf(RealtimeCollaborationPlugin::class, $this->plugin);
    }
