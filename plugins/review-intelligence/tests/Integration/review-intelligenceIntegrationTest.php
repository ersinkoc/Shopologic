...
namespace Tests\Integration\review-intelligence;

use PHPUnit\Framework\TestCase;

/**
 * Integration tests for review-intelligence plugin
 */
class review-intelligenceIntegrationTest extends TestCase
{
