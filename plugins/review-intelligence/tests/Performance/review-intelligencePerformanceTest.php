...
namespace Tests\Performance\review-intelligence;

use PHPUnit\Framework\TestCase;

/**
 * Performance tests for review-intelligence plugin
 */
class review-intelligencePerformanceTest extends TestCase
{
