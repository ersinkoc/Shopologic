...
namespace Tests\Unit\review-intelligence;

use PHPUnit\Framework\TestCase;
use Shopologic\Plugins\ReviewIntelligence\ReviewIntelligencePlugin;
use Shopologic\Core\Container\Container;

/**
 * Unit tests for ReviewIntelligencePlugin
 */
class ReviewIntelligencePluginTest extends TestCase
{
    private ReviewIntelligencePlugin $plugin;
    ...
    protected function setUp(): void
    {
        ...
        $this->plugin = new ReviewIntelligencePlugin($this->container, '/fake/path');
    }
    
    public function testPluginInstantiation(): void
    {
        $this->assertInstanceOf(ReviewIntelligencePlugin::class, $this->plugin);
    }
