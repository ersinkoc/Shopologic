...
namespace Tests\Unit\reviews-ratings;

use PHPUnit\Framework\TestCase;
use Shopologic\Plugins\ReviewsRatings\ReviewsRatingsPlugin;
use Shopologic\Core\Container\Container;

/**
 * Unit tests for ReviewsRatingsPlugin
 */
class ReviewsRatingsPluginTest extends TestCase
{
    private ReviewsRatingsPlugin $plugin;
    ...
    protected function setUp(): void
    {
        ...
        $this->plugin = new ReviewsRatingsPlugin($this->container, '/fake/path');
    }
    
    public function testPluginInstantiation(): void
    {
        $this->assertInstanceOf(ReviewsRatingsPlugin::class, $this->plugin);
    }
