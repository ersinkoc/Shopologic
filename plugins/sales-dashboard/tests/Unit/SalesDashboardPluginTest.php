...
namespace Tests\Unit\sales-dashboard;

use PHPUnit\Framework\TestCase;
use Shopologic\Plugins\SalesDashboard\SalesDashboardPlugin;
use Shopologic\Core\Container\Container;

/**
 * Unit tests for SalesDashboardPlugin
 */
class SalesDashboardPluginTest extends TestCase
{
    private SalesDashboardPlugin $plugin;
    ...
    protected function setUp(): void
    {
        ...
        $this->plugin = new SalesDashboardPlugin($this->container, '/fake/path');
    }
    
    public function testPluginInstantiation(): void
    {
        $this->assertInstanceOf(SalesDashboardPlugin::class, $this->plugin);
    }
