...
namespace Tests\Unit\seo-optimizer;

use PHPUnit\Framework\TestCase;
use Shopologic\Plugins\SeoOptimizer\SeoOptimizerPlugin;
use Shopologic\Core\Container\Container;

/**
 * Unit tests for SeoOptimizerPlugin
 */
class SeoOptimizerPluginTest extends TestCase
{
    private SeoOptimizerPlugin $plugin;
    ...
    protected function setUp(): void
    {
        ...
        $this->plugin = new SeoOptimizerPlugin($this->container, '/fake/path');
    }
    
    public function testPluginInstantiation(): void
    {
        $this->assertInstanceOf(SeoOptimizerPlugin::class, $this->plugin);
    }
