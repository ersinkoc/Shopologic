...
namespace Tests\Integration\serverless-functions;

use PHPUnit\Framework\TestCase;

/**
 * Integration tests for serverless-functions plugin
 */
class serverless-functionsIntegrationTest extends TestCase
{
