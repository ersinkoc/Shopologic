...
namespace Tests\Performance\serverless-functions;

use PHPUnit\Framework\TestCase;

/**
 * Performance tests for serverless-functions plugin
 */
class serverless-functionsPerformanceTest extends TestCase
{
