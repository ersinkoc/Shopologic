...
namespace Tests\Unit\serverless-functions;

use PHPUnit\Framework\TestCase;
use Shopologic\Plugins\ServerlessFunctions\ServerlessFunctionsPlugin;
use Shopologic\Core\Container\Container;

/**
 * Unit tests for ServerlessFunctionsPlugin
 */
class ServerlessFunctionsPluginTest extends TestCase
{
    private ServerlessFunctionsPlugin $plugin;
    ...
    protected function setUp(): void
    {
        ...
        $this->plugin = new ServerlessFunctionsPlugin($this->container, '/fake/path');
    }
    
    public function testPluginInstantiation(): void
    {
        $this->assertInstanceOf(ServerlessFunctionsPlugin::class, $this->plugin);
    }
