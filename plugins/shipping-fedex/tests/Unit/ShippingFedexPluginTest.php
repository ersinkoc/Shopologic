...
namespace Tests\Unit\shipping-fedex;

use PHPUnit\Framework\TestCase;
use Shopologic\Plugins\ShippingFedex\ShippingFedexPlugin;
use Shopologic\Core\Container\Container;

/**
 * Unit tests for ShippingFedexPlugin
 */
class ShippingFedexPluginTest extends TestCase
{
    private ShippingFedexPlugin $plugin;
    ...
    protected function setUp(): void
    {
        ...
        $this->plugin = new ShippingFedexPlugin($this->container, '/fake/path');
    }
    
    public function testPluginInstantiation(): void
    {
        $this->assertInstanceOf(ShippingFedexPlugin::class, $this->plugin);
    }
