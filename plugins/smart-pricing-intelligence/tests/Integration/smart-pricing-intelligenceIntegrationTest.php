...
namespace Tests\Integration\smart-pricing-intelligence;

use PHPUnit\Framework\TestCase;

/**
 * Integration tests for smart-pricing-intelligence plugin
 */
class smart-pricing-intelligenceIntegrationTest extends TestCase
{
