...
namespace Tests\Performance\smart-pricing-intelligence;

use PHPUnit\Framework\TestCase;

/**
 * Performance tests for smart-pricing-intelligence plugin
 */
class smart-pricing-intelligencePerformanceTest extends TestCase
{
