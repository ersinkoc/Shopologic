...
namespace Tests\Security\smart-pricing-intelligence;

use PHPUnit\Framework\TestCase;

/**
 * Security tests for smart-pricing-intelligence plugin
 */
class smart-pricing-intelligenceSecurityTest extends TestCase
{
