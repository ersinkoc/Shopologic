...
namespace Tests\Unit\smart-pricing-intelligence;

use PHPUnit\Framework\TestCase;
use Shopologic\Plugins\SmartPricingIntelligence\SmartPricingIntelligencePlugin;
use Shopologic\Core\Container\Container;

/**
 * Unit tests for SmartPricingIntelligencePlugin
 */
class SmartPricingIntelligencePluginTest extends TestCase
{
    private SmartPricingIntelligencePlugin $plugin;
    ...
    protected function setUp(): void
    {
        ...
        $this->plugin = new SmartPricingIntelligencePlugin($this->container, '/fake/path');
    }
    
    public function testPluginInstantiation(): void
    {
        $this->assertInstanceOf(SmartPricingIntelligencePlugin::class, $this->plugin);
    }
