...
namespace Tests\Unit\smart-pricing;

use PHPUnit\Framework\TestCase;
use Shopologic\Plugins\SmartPricing\SmartPricingPlugin;
use Shopologic\Core\Container\Container;

/**
 * Unit tests for SmartPricingPlugin
 */
class SmartPricingPluginTest extends TestCase
{
    private SmartPricingPlugin $plugin;
    ...
    protected function setUp(): void
    {
        ...
        $this->plugin = new SmartPricingPlugin($this->container, '/fake/path');
    }
    
    public function testPluginInstantiation(): void
    {
        $this->assertInstanceOf(SmartPricingPlugin::class, $this->plugin);
    }
