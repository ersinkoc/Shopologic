...
namespace Tests\Security\smart-search-discovery;

use PHPUnit\Framework\TestCase;

/**
 * Security tests for smart-search-discovery plugin
 */
class smart-search-discoverySecurityTest extends TestCase
{
