...
namespace Tests\Unit\smart-search-discovery;

use PHPUnit\Framework\TestCase;
use Shopologic\Plugins\SmartSearchDiscovery\SmartSearchDiscoveryPlugin;
use Shopologic\Core\Container\Container;

/**
 * Unit tests for SmartSearchDiscoveryPlugin
 */
class SmartSearchDiscoveryPluginTest extends TestCase
{
    private SmartSearchDiscoveryPlugin $plugin;
    ...
    protected function setUp(): void
    {
        ...
        $this->plugin = new SmartSearchDiscoveryPlugin($this->container, '/fake/path');
    }
    
    public function testPluginInstantiation(): void
    {
        $this->assertInstanceOf(SmartSearchDiscoveryPlugin::class, $this->plugin);
    }
