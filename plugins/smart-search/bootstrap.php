...
/**
 * Smart Search Engine Plugin Bootstrap
 * 
 * @package Shopologic\Plugins\SmartSearch
 * @version 1.0.0
 */

declare(strict_types=1);

namespace Shopologic\Plugins\SmartSearch;
...
return function(Container $container, string $pluginPath) {
    return new SmartSearchPlugin($container, $pluginPath);
};