...
namespace Tests\Unit\smart-search;

use PHPUnit\Framework\TestCase;
use Shopologic\Plugins\SmartSearch\SmartSearchPlugin;
use Shopologic\Core\Container\Container;

/**
 * Unit tests for SmartSearchPlugin
 */
class SmartSearchPluginTest extends TestCase
{
    private SmartSearchPlugin $plugin;
    ...
    protected function setUp(): void
    {
        ...
        $this->plugin = new SmartSearchPlugin($this->container, '/fake/path');
    }
    
    public function testPluginInstantiation(): void
    {
        $this->assertInstanceOf(SmartSearchPlugin::class, $this->plugin);
    }
