...
namespace Tests\Unit\smart-shipping;

use PHPUnit\Framework\TestCase;
use Shopologic\Plugins\SmartShipping\SmartShippingPlugin;
use Shopologic\Core\Container\Container;

/**
 * Unit tests for SmartShippingPlugin
 */
class SmartShippingPluginTest extends TestCase
{
    private SmartShippingPlugin $plugin;
    ...
    protected function setUp(): void
    {
        ...
        $this->plugin = new SmartShippingPlugin($this->container, '/fake/path');
    }
    
    public function testPluginInstantiation(): void
    {
        $this->assertInstanceOf(SmartShippingPlugin::class, $this->plugin);
    }
