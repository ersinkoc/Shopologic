...
namespace Tests\Performance\social-commerce-integration;

use PHPUnit\Framework\TestCase;

/**
 * Performance tests for social-commerce-integration plugin
 */
class social-commerce-integrationPerformanceTest extends TestCase
{
