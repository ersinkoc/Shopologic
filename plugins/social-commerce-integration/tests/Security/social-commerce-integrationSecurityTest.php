...
namespace Tests\Security\social-commerce-integration;

use PHPUnit\Framework\TestCase;

/**
 * Security tests for social-commerce-integration plugin
 */
class social-commerce-integrationSecurityTest extends TestCase
{
