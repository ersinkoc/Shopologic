...
namespace Tests\Unit\social-commerce-integration;

use PHPUnit\Framework\TestCase;
use Shopologic\Plugins\SocialCommerceIntegration\SocialCommerceIntegrationPlugin;
use Shopologic\Core\Container\Container;

/**
 * Unit tests for SocialCommerceIntegrationPlugin
 */
class SocialCommerceIntegrationPluginTest extends TestCase
{
    private SocialCommerceIntegrationPlugin $plugin;
    ...
    protected function setUp(): void
    {
        ...
        $this->plugin = new SocialCommerceIntegrationPlugin($this->container, '/fake/path');
    }
    
    public function testPluginInstantiation(): void
    {
        $this->assertInstanceOf(SocialCommerceIntegrationPlugin::class, $this->plugin);
    }
