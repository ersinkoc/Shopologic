...
namespace Tests\Integration\social-proof-engine;

use PHPUnit\Framework\TestCase;

/**
 * Integration tests for social-proof-engine plugin
 */
class social-proof-engineIntegrationTest extends TestCase
{
