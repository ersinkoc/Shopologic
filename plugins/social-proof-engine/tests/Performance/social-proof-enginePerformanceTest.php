...
namespace Tests\Performance\social-proof-engine;

use PHPUnit\Framework\TestCase;

/**
 * Performance tests for social-proof-engine plugin
 */
class social-proof-enginePerformanceTest extends TestCase
{
