...
namespace Tests\Unit\social-proof-engine;

use PHPUnit\Framework\TestCase;
use Shopologic\Plugins\SocialProofEngine\SocialProofEnginePlugin;
use Shopologic\Core\Container\Container;

/**
 * Unit tests for SocialProofEnginePlugin
 */
class SocialProofEnginePluginTest extends TestCase
{
    private SocialProofEnginePlugin $plugin;
    ...
    protected function setUp(): void
    {
        ...
        $this->plugin = new SocialProofEnginePlugin($this->container, '/fake/path');
    }
    
    public function testPluginInstantiation(): void
    {
        $this->assertInstanceOf(SocialProofEnginePlugin::class, $this->plugin);
    }
