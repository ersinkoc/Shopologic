...
namespace Tests\Performance\subscription-commerce;

use PHPUnit\Framework\TestCase;

/**
 * Performance tests for subscription-commerce plugin
 */
class subscription-commercePerformanceTest extends TestCase
{
