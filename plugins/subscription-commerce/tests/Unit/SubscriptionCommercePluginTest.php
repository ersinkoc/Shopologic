...
namespace Tests\Unit\subscription-commerce;

use PHPUnit\Framework\TestCase;
use Shopologic\Plugins\SubscriptionCommerce\SubscriptionCommercePlugin;
use Shopologic\Core\Container\Container;

/**
 * Unit tests for SubscriptionCommercePlugin
 */
class SubscriptionCommercePluginTest extends TestCase
{
    private SubscriptionCommercePlugin $plugin;
    ...
    protected function setUp(): void
    {
        ...
        $this->plugin = new SubscriptionCommercePlugin($this->container, '/fake/path');
    }
    
    public function testPluginInstantiation(): void
    {
        $this->assertInstanceOf(SubscriptionCommercePlugin::class, $this->plugin);
    }
