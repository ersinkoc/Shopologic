...
/**
 * Customer Support Hub Plugin Bootstrap
 * 
 * @package Shopologic\Plugins\SupportHub
 * @version 1.0.0
 */

declare(strict_types=1);

namespace Shopologic\Plugins\SupportHub;
...
return function(Container $container, string $pluginPath) {
    return new SupportHubPlugin($container, $pluginPath);
};