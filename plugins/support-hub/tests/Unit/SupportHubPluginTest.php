...
namespace Tests\Unit\support-hub;

use PHPUnit\Framework\TestCase;
use Shopologic\Plugins\SupportHub\SupportHubPlugin;
use Shopologic\Core\Container\Container;

/**
 * Unit tests for SupportHubPlugin
 */
class SupportHubPluginTest extends TestCase
{
    private SupportHubPlugin $plugin;
    ...
    protected function setUp(): void
    {
        ...
        $this->plugin = new SupportHubPlugin($this->container, '/fake/path');
    }
    
    public function testPluginInstantiation(): void
    {
        $this->assertInstanceOf(SupportHubPlugin::class, $this->plugin);
    }
