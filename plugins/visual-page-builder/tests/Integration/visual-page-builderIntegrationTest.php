...
namespace Tests\Integration\visual-page-builder;

use PHPUnit\Framework\TestCase;

/**
 * Integration tests for visual-page-builder plugin
 */
class visual-page-builderIntegrationTest extends TestCase
{
