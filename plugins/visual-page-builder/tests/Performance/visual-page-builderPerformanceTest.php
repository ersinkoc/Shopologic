...
namespace Tests\Performance\visual-page-builder;

use PHPUnit\Framework\TestCase;

/**
 * Performance tests for visual-page-builder plugin
 */
class visual-page-builderPerformanceTest extends TestCase
{
