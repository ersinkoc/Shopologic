...
namespace Tests\Unit\visual-page-builder;

use PHPUnit\Framework\TestCase;
use Shopologic\Plugins\VisualPageBuilder\VisualPageBuilderPlugin;
use Shopologic\Core\Container\Container;

/**
 * Unit tests for VisualPageBuilderPlugin
 */
class VisualPageBuilderPluginTest extends TestCase
{
    private VisualPageBuilderPlugin $plugin;
    ...
    protected function setUp(): void
    {
        ...
        $this->plugin = new VisualPageBuilderPlugin($this->container, '/fake/path');
    }
    
    public function testPluginInstantiation(): void
    {
        $this->assertInstanceOf(VisualPageBuilderPlugin::class, $this->plugin);
    }
