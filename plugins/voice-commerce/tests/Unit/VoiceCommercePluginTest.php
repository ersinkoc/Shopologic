...
namespace Tests\Unit\voice-commerce;

use PHPUnit\Framework\TestCase;
use Shopologic\Plugins\VoiceCommerce\VoiceCommercePlugin;
use Shopologic\Core\Container\Container;

/**
 * Unit tests for VoiceCommercePlugin
 */
class VoiceCommercePluginTest extends TestCase
{
    private VoiceCommercePlugin $plugin;
    ...
    protected function setUp(): void
    {
        ...
        $this->plugin = new VoiceCommercePlugin($this->container, '/fake/path');
    }
    
    public function testPluginInstantiation(): void
    {
        $this->assertInstanceOf(VoiceCommercePlugin::class, $this->plugin);
    }
