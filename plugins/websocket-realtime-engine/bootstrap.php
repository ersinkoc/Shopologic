...
/**
 * websocket-realtime-engine Plugin Bootstrap
 * 
 * @package Shopologic\Plugins\WebsocketRealtimeEngine
 * @version 1.0.0
 */
...
return function(Container $container, string $pluginPath) {
    return new WebsocketRealtimeEnginePlugin($container, $pluginPath);
};