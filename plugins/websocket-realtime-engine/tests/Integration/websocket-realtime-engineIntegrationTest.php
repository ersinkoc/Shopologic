...
namespace Tests\Integration\websocket-realtime-engine;

use PHPUnit\Framework\TestCase;

/**
 * Integration tests for websocket-realtime-engine plugin
 */
class websocket-realtime-engineIntegrationTest extends TestCase
{
