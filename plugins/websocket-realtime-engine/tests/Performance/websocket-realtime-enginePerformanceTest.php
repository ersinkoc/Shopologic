...
namespace Tests\Performance\websocket-realtime-engine;

use PHPUnit\Framework\TestCase;

/**
 * Performance tests for websocket-realtime-engine plugin
 */
class websocket-realtime-enginePerformanceTest extends TestCase
{
