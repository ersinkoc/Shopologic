...
namespace Tests\Security\websocket-realtime-engine;

use PHPUnit\Framework\TestCase;

/**
 * Security tests for websocket-realtime-engine plugin
 */
class websocket-realtime-engineSecurityTest extends TestCase
{
