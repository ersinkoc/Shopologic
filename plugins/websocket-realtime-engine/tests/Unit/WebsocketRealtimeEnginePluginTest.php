...
namespace Tests\Unit\websocket-realtime-engine;

use PHPUnit\Framework\TestCase;
use Shopologic\Plugins\WebsocketRealtimeEngine\WebsocketRealtimeEnginePlugin;
use Shopologic\Core\Container\Container;

/**
 * Unit tests for WebsocketRealtimeEnginePlugin
 */
class WebsocketRealtimeEnginePluginTest extends TestCase
{
    private WebsocketRealtimeEnginePlugin $plugin;
    ...
    protected function setUp(): void
    {
        ...
        $this->plugin = new WebsocketRealtimeEnginePlugin($this->container, '/fake/path');
    }
    
    public function testPluginInstantiation(): void
    {
        $this->assertInstanceOf(WebsocketRealtimeEnginePlugin::class, $this->plugin);
    }
