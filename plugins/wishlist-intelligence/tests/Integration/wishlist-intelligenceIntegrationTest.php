...
namespace Tests\Integration\wishlist-intelligence;

use PHPUnit\Framework\TestCase;

/**
 * Integration tests for wishlist-intelligence plugin
 */
class wishlist-intelligenceIntegrationTest extends TestCase
{
