...
namespace Tests\Performance\wishlist-intelligence;

use PHPUnit\Framework\TestCase;

/**
 * Performance tests for wishlist-intelligence plugin
 */
class wishlist-intelligencePerformanceTest extends TestCase
{
