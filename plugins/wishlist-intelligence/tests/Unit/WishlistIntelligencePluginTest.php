...
namespace Tests\Unit\wishlist-intelligence;

use PHPUnit\Framework\TestCase;
use Shopologic\Plugins\WishlistIntelligence\WishlistIntelligencePlugin;
use Shopologic\Core\Container\Container;

/**
 * Unit tests for WishlistIntelligencePlugin
 */
class WishlistIntelligencePluginTest extends TestCase
{
    private WishlistIntelligencePlugin $plugin;
    ...
    protected function setUp(): void
    {
        ...
        $this->plugin = new WishlistIntelligencePlugin($this->container, '/fake/path');
    }
    
    public function testPluginInstantiation(): void
    {
        $this->assertInstanceOf(WishlistIntelligencePlugin::class, $this->plugin);
    }
